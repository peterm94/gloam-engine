...
var clipboard = null, wasm_memory, FS, GL, Module, wasm_exports, emscripten_shaders_hack, importObject, ctx, js_objects, unique_js_id, quad_socket, connected, received_buffer, uid, ongoing_requests, plugins = [], high_dpi = !1;
canvas.focus(),
    ...
    for (var n, s, t = 0; t < e.length; t++)
        e[t].on_init != void 0 && e[t].on_init != null && e[t].on_init(),
            e[t].name == void 0 || e[t].name == null || e[t].version == void 0 || e[t].version == null ? (console.warn("Some of the registred plugins do not have name or version"),
                ...
                wasm_exports[n] == void 0 ? console.log("Plugin " + e[t].name + " is present in JS bundle, but is not used in the rust code.") : (s = u32_to_semver(wasm_exports[n]()),
